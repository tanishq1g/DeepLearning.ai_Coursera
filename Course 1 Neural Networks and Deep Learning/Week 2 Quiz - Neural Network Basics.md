...
2. Which of these is the "Logistic Loss"?
    ...
    compare from lecture we are using cross entropy
...
4. Consider the two following random arrays "a" and "b":
    ...
    Note: This is broadcasting. b (column vector) is copied 3 times so that it can be summed to each column of a.
...
5. Consider the two following random arrays "a" and "b":
    ...
    Note: In numpy the "*" operator indicates element-wise multiplication. It is different from "np.dot()". If you would try "c = np.dot(a,b)" you would get c.shape = (4, 2).
